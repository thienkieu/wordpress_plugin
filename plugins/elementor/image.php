 ...
 * @since 1.0.0
 */
class Responsive_Widget_Image extends Widget_Base {
	...
	public function get_title() {
		return __( 'Responsive Image', 'elementor' );
	}
...
\add_filter('elementor/image_size/get_attachment_image_html', 'addResponsiveImage', 10, 2);